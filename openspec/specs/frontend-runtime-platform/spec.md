# Spec: Frontend Runtime Platform

## Purpose

Defines the frontend runtime platform contract for the P2P Uno application, including SPA runtime requirements, route compatibility, deployment deep-link behavior, and framework dependency boundaries.
