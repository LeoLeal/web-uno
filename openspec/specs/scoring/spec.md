...
This capability defines the scoring system for multi-round Uno games, including point calculation, cumulative score tracking, round management, and win conditions based on score limits.
